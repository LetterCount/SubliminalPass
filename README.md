...
```
## Changelog
SubliminalPass has been completely rewritten to be more object-oriented and abstract even more of the methods found in the original version. 
...
# Vulnerability
As mentioned at the top, this was made as a project and not intended for actual use. I will explain in just a few words what any expert hacker can accomplish by exploiting a vulnerability. Just kidding, anyone can do this. Anyway, ince the files are stored locally, they can easily be deleted without needing to enter any credentials and consequently all stored passwords are gone along with other data.
